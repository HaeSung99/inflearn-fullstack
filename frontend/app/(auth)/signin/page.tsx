...
export default function SigninPage() {
    ...
    return (
        <div className="flex flex-col items-center justfy-center h-screen gap-4">
            ...
            <p className="text-gray-700">인프런 게정으로 로그인할 수 있어요</p>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-2 min-w-[300px]">
                ...
                <button type="submit" className="font-bold text-white text-center bg-green-400 rounded-sm p-2">로그인</button>
                <Link href="/signup" className="font-bold text-white text-center bg-green-400 rounded-sm p-2">회원가입</Link>
            </form>
        </div>
    )
} 